  ...
  return (
    <main className=" w-full max-[385px]:h-[180vh] h-[140vh] sm:[100vh] bg-[#058369] font-sans ">
      ...
      <div className=" w-full sm:fixed  max-[385px]:h-[160vh] h-[120vh] sm:h-[100vh] hero absolute top-0 mt-20  z-0">
        ...
        <div
          id="form"
          className="flex-col absolute bottom-0 z-30 right-5 left-3 max-[385px]:h-[45%] h-[55%] lg:pl-20 lg:pr-20  min-[450px]:px-8 min-[450px]:left-1 min-[600px]:px-10  2xl:py-36  sm:bottom-auto sm:left-auto  sm:right-0 sm:top-5 justify-center sm:w-[45%] sm:h-[80%] sm:px-24 sm:py-20 "
        >
          <div className="px-8 ">
