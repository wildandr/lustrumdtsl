    ...
    <main className=" w-full max-[385px]:h-[180vh] h-[140vh] sm:[100vh] bg-[#058369] font-sans ">
      ...
      <div className=" w-full sm:fixed  max-[385px]:h-[160vh] h-[120vh] sm:h-[100vh] hero absolute top-0 mt-20  z-0">
        <Image
          ...
          width={500}
          height={500}
          className="hidden sm:flex w-[45%] absolute right-0 top-10 h-[70%] "
        />
        <Image
          ...
          width={500}
          height={500}
          className="z-20 sm:hidden absolute bottom-0 right-5 left-5 max-[385px]:h-[45%] h-[53%]  w-[92vw]"
        />

        <div
          id="form"
          className="flex-col absolute bottom-0 z-30 right-5 left-3 max-[385px]:h-[40%] h-[45%] lg:w-1/2 lg:pl-36 lg:pr-20 min-[450px]:px-8 min-[450px]:left-1 min-[600px]:px-10  2xl:py-36  sm:bottom-auto sm:left-auto  sm:right-0 sm:top-5 justify-center sm:w-[45%] sm:h-[80%] sm:px-24 sm:py-28 "
        >
          <div className="px-8 ">
          ...
          <div className="flex-col flex w-full  px-8  mt-4 gap-4 min-[385px]:gap-6">
            <Input
            ...
            <button className="bg-[#18AB8E] max-[385px]:mt-3 z-50 p-2 rounded-xl font-sans font-light shadow-md hover:bg-[#469485]">
              Login
            </button>
          </div>
        </div>
