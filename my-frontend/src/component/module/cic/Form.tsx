...
export function Form() {
  ...
  const Member3Ktm = teamData.member3.ktm.split("/uploads/cic/");
  const Member3SPSA =
    teamData.member3.active_student_letter.split("/uploads/cic/");
  const Member3Foto = teamData.member3.photo.split("/uploads/cic/");
                    ...
                    <form className="w-full flex flex-col gap-4 font-sans">
                      ...
                      <Input
                        ...
                        label={
                          <>
                            ...
                            >
                              {" "}
                              (Ketua Wajib berasal dari teknik sipil)
                            </span>
                          </>
                        }
                        variant="underlined"
                      ...
                      <div className="flex flex-col gap-1 border-b-2 pb-2 border-[#18AB8E] ">
                        <p className="text-black text-[0.7rem] lg:text-[12px] ml-1">
                          ...
                          >
                            (Peserta harap tidak menggunakan private account)
                          </span>
                        </p>
                        <input
                          type="text"
                      ...
                      <div className="flex flex-col gap-1 border-b-2 pb-2 border-[#18AB8E] ">
                        <p className="text-black text-[0.7rem] lg:text-[12px] ml-1">
                          ...
                          >
                            (Format Penamaan : SKMA_Nama Tim_Nama Lengkap)
                          </span>
                        </p>
                        <input
                          type="file"
                      ...
                      <div className="flex flex-col gap-1 border-b-2 pb-2 border-[#18AB8E]">
                        <p className="text-black text-[0.7rem]  lg:text-[12px] ml-1">
                          ...
                          >
                            (Format Penamaan : Pas Foto_Nama Tim_Nama Lengkap)
                          </span>
                        </p>
                        <input
                          type="file"
                  ...
                  >
                    <form className="w-full flex flex-col gap-4">
                      ...
                      <Input
                        ...
                        variant="underlined"
                        color="primary"
                        value={teamData.member1.department}
                        onChange={(e) => {
                          setTeamData((prevState) => ({
                            ...prevState,
                            member1: {
                    ...
                    <form className="w-full flex flex-col gap-4">
                      ...
                      <div className="flex flex-col gap-1 border-b-2 pb-2 border-[#18AB8E] ">
                        ...
                        <input
                          ...
                          required
                          accept="application/pdf"
                          onChange={onFileChange("member3")}
                        ></input>
                        {selectedFile && (
                          <p className="text-xs md:text-sm text-ciaGreen">
                            Selected file: {Member3SPSA}
                          </p>
                        )}
                      </div>
                      <div className="flex flex-col gap-1 border-b-2 pb-2 border-[#18AB8E]">
