...
export function Form() {
  ...
  const onFileChange =
        ...
        if (
          ...
          if (response.success) {
            setTeamData((prevState: any) => {
              ...
              if (
                /^[^_]*_Surat Pernyataan Siswa Aktif_[^_]*\..*$/.test(file.name)
              ) {
                updatedField = "active_student_letter";
              } else if (/^[^_]*_Kartu Identitas_[^_]*\..*$/.test(file.name)) {
                updatedField = "ktm";
              } else if (/^[^_]*_Pas Foto_[^_]*\..*$/.test(file.name)) {
                updatedField = "photo";
              } else if (/^.*_Abstrak\..*$/.test(file.name)) {
                updatedField = "abstract_file";
              } else if (
                /^.*_Surat Pernyataan Orisinalitas\..*$/.test(file.name)
              ) {
    ...
    const LeaderKtm = teamData.leader.ktm.split("/uploads/fcec/");
    const LeaderSPSA = teamData.leader.active_student_letter.split("/uploads/fcec/");
    const LeaderFoto = teamData.leader.photo.split("/uploads/fcec/");
    const Member1Ktm = teamData.member1.ktm.split("/uploads/fcec/");
    const Member1SPSA = teamData.member1.active_student_letter.split("/uploads/fcec/");
    const Member1Foto= teamData.member1.photo.split("/uploads/fcec/");
    const Member2Ktm = teamData.member2.ktm.split("/uploads/fcec/");
    const Member2SPSA = teamData.member2.active_student_letter.split("/uploads/fcec/");
    const Member2Foto= teamData.member2.photo.split("/uploads/fcec/");
        ...
        <div className="lg:mt-[8%] mt-[8%] min-h-screen z-50 flex flex-col">
          ...
          <div className="font-LibreBaskerville text-cia-green lg:mx-[15%] mt-[3%] lg:mb-[1%] lg:text-lg text-xs min-w-screen mx-[17%]">
            <p className="">
              ...
              rangkaian acara 12th Civil in Action yang berfokus pada karya
              tulis ilmiah di bidang teknik sipil, lingkungan, dan sumber daya
              air untuk tingkatan SMA dan/atau sederajat. FCEC 2024 mengusung
              tema “Strategi generasi muda dalam menciptakan pembangunan
              berwawasan lingkungan dan pemanfaatan sumberdaya berkelanjutan”.
            </p>
            <p className="mt-5">
              📌 Periode pendaftaran: 17 Februari 2024 - 10 Maret 2024 pukul
              23:59 WIB
            </p>
            <p className="mt-5">
              Contact Person: <br />
          ...
          <form className="w-full lg:px-[15%] px-[16%] flex flex-col gap-4 font-sans ">
            ...
            <div className="flex flex-col gap-1 border-b-2 pb-2 border-[#18AB8E] ">
              <p className="text-black text-[0.7rem] lg:text-[12px] ml-1">
                File Abstrak <span className="text-red-500">*</span>{" "}
                <span
                  style={{
                    color: "gray",
                  }}
                    ...
                    <form className="w-full flex flex-col gap-4 font-sans">
                      ...
                      <div className="flex flex-col gap-1 border-b-2 pb-2 border-[#18AB8E] ">
                        <p className="text-black text-[0.7rem]  lg:text-[12px] ml-1">
                          ...
                          >
                            (Format Penamaan : Nama Tim_Kartu Identitas_Nama
                            Lengkap )
                          </span>
                        </p>
                        <input
                        ...
                        ></input>
                        {selectedFile && (
                          <p className="text-ciaGreen text-xs md:text-sm">
                      ...
                      <div className="flex flex-col gap-1 border-b-2 pb-2 border-[#18AB8E] ">
                        <p className="text-black text-[0.7rem]  lg:text-[12px] ml-1">
                          ...
                          >
                            (Format Penamaan : Nama Tim_Surat Pernyataan Siswa
                            Aktif_Nama Lengkap)
                          </span>
                        </p>
                        <input
                      ...
                      <div className="flex flex-col gap-1 border-b-2 pb-2 border-[#18AB8E] ">
                        <p className="text-black text-[0.7rem]  lg:text-[12px] ml-1">
                          {" "}
                          Pas Foto 3x4 <span className="text-red-500">
                            *
                          </span>{" "}
                          <span
                            style={{
                          ...
                          >
                            (Format Penamaan : Nama Tim_Pas Foto_Nama Lengkap )
                          </span>
                        </p>
                        <input
                          type="file"
