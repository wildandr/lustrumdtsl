        ...
        <div id="tema_claproyex" className='flex flex-col w-full'>
            <div className='hidden lg:flex flex-col items-end z-50' style={backgroundImage}>
                ...
                <div className='w-[65%] ps-[10%] lg:mt-[17rem] xl:mt-[23rem] 1440:mt-[27rem] 16k:mt-[34rem] mb-[32rem] 1440:mb-[34rem] 16k:mb-[38rem] self-start'>
                    <p style={{textShadow: '2.123px 3.538px 0px rgba(0, 0, 0, 0.25)'}} className={`${league_spartan.className} lg:text-5xl xl:text-6xl 2xl:text-7xl text-[#F9E4AB] font-bold text-right`}>Rangkaian Kegiatan Claproyex #8</p>
                </div>
            </div>
            <div className='min-h-screen lg:hidden flex flex-col items-center z-50 relative pb-[10%]'>
                ...
                <div className='w-[80%] pt-[33%] md:pt-[45%] flex flex-col z-50'>
                    ...
                    <p style={{textShadow: '2.123px 3.538px 0px rgba(0, 0, 0, 0.25)'}} className={`${league_spartan.className} text-xl md:text-4xl xl:text-4xl 2xl:text-5xl text-[#F9E4AB] font-bold text-center mb-4 md:mb-12`}>“Menyuarakan Narasi Pembangunan Menuju Sumberdaya Air Berkelanjutan di Indonesia”</p>
                ...
                <div className='w-full flex justify-center items-center z-49 py-[30%] mt-[15%] md:mt-0 pt-[40%] md:pt-[30%] px-[10%]' style={backgroundMobile}>
                    <p style={{textShadow: '2.123px 3.538px 0px rgba(0, 0, 0, 0.25)'}} className={`${league_spartan.className} text-4xl md:text-6xl text-[#F9E4AB] font-bold text-center pt-[30%] md:pt-[50%]`}>Rangkaian Kegiatan Claproyex #8</p>
                </div>
            </div>
        </div>
    )
