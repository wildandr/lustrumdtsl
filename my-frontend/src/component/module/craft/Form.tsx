        ...
        <div className="lg:mt-[8%] mt-[8%] min-h-screen w-full z-50 flex flex-col px-3">
          ...
          <div className="font-LibreBaskerville text-cia-green lg:mx-[15%] mt-[3%] lg:mb-[1%] lg:text-lg text-xs min-w-screen mx-[17%]">
            <ol className="list-decimal pl-2">
              ...
              <li className="mb-1">
                Peserta mencantumkan email aktif untuk mendapatkan email balasan
                nantinya
              </li>
              <li className="mb-1">
                Peserta dapat memilih 2 opsi kehadiran (offline/online)
              </li>
              <li className="mb-1">
                Peserta menyerahkan bukti pembayaran pada formulir (PDF).
                <br /> Format penamaan file : Bukti Pembayaran_Nama Peserta{" "}
                <br /> Contoh : Bukti Pembayaran_Dimas Apta <br /> Biaya
                pendaftaran yang harus dibayarkan sejumlah berikut : <br />{" "}
                Tiket Early Bird (18-24 Maret 2024) <br /> Umum offline : Rp
                40.000 <br /> Umum online : Rp 30.000 <br />
                ...
                Pembayaran dilakukan melalui rekening 1800013302668 (Mandiri)
                a.n Balqis Sybil Buanawati
              </li>
              <li className="mb-1">
                Apabila terdapat kendala dan kesalahan dalam mengisi google form
                dapat menghubungi Contact Person: <br />
                  ...
                  <div>
                    ...
                    <RadioGroup
                      ...
                      onChange={(e) =>
                        setCraftData({
                          ...craftData,
                          isMahasiswaDTSL: e.target.value === "true",
                        })
                      }
                    >
                    ...
                    <div className="flex flex-col gap-1 border-b-2 mt-2 pb-2 border-[#18AB8E]">
                      <p className="text-black text-[0.7rem] lg:text-[12px] ml-1">
                        ...
                        >
                          (Format Penamaan : KTM_Nama Peserta)
                        </span>
                      </p>
                      <input
                        type="file"
