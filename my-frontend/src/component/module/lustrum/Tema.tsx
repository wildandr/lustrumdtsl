    ...
    return (
        <div className='min-h-screen p-6 flex flex-col items-center justify-center bg-black relative overflow-x-clip'>
            ...
            <div className='absolute min-h-screen w-full'>
                ...
                ></div>
                <div
                    className="-left-[100%] -top-[15%] lg:top-auto lg:-bottom-[10%] lg:left-auto lg:-right-[20%] w-[36rem] h-[36rem] lg:w-[40rem] lg:h-[40rem] mix-blend-lighten"
                    style={{
                        background: "radial-gradient(50% 50% at 50% 50%, rgba(137, 108, 0, 0.35) 0%, rgba(255, 235, 162, 0.00) 100%)",
                        filter: 'box-shadow(0px 0px 50px rgba(251, 222, 11, 1))',
                        borderRadius: '50%',
            ...
            <div className='flex min-h-screen w-full justify-center mt-[60%] ms-[80%] lg:mt-[0%] md:ms-0 absolute'>
                <Image
                 src={'/assets/lustrum/logo_kmtsl_vektor.svg'}
                 className={`w-[32rem] h-auto absolute`}
                 width={1000}
                 height={1000}
                 alt={''}
                 style={{}}
