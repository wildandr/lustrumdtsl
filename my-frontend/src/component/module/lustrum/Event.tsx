...
export function Event() {
    ...
    return (
        ...
        <div className='min-h-screen p-6 flex flex-col items-center justify-center bg-black relative overflow-x-clip'>
            ...
            <div className='flex flex-col md:w-[60vw] lg:w-[71vw] relative z-[100]'>
                <p className='text-xs md:text-sm lg:text-base font-LibreBaskerville font-bold bg-gradient-to-b text-transparent bg-clip-text from-yellow-300 to-yellow-500'>CLAPROYEX #8</p>
                <p className='text-2xl md:text-3xl lg:text-5xl font-LibreBaskerville font-bold bg-gradient-to-b text-transparent bg-clip-text from-yellow-300 to-yellow-500'>Clapeyron Proyek dan Expo Ke-8</p>
                <p className='text-xs md:text-sm lg:text-xl font-LibreBaskerville font-bold bg-gradient-to-b text-transparent bg-clip-text from-yellow-300 to-yellow-500'>CLAPROYEX #8 (Clapeyron Proyek dan Expo Ke-8) adalah acara yang diselenggarakan oleh Badan Pers Mahasiswa Teknik Sipil Clapeyron UGM dengan tema "Menyuarakan Narasi Pembangunan Menuju Sumberdaya Air Berkelanjutan di Indonesia." Tujuan acara ini adalah meningkatkan pemahaman dan kesadaran masyarakat tentang urgensi pengelolaan sumber daya air yang berkelanjutan. Melalui platform ini, Badan Pers ingin menjadi jembatan informasi dan edukasi antara mahasiswa dan masyarakat umum.</p>
                <button style={{border: "1px solid var(--gold, #F2D87A)"}} className='w-fit flex flex-row items-center border text-gold-500 px-4 py-2 mt-4 rounded-md font-bold text-xs lg:text-base hover:opacity-80'>Website CLAPROYEx 
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="100" viewBox="0 0 24 24" className="fill-current text-gold-500 h-5">
                            <path d="M11.109,3L11.109,3C9.78,3,8.988,4.481,9.725,5.587L14,12l-4.275,6.413C8.988,19.519,9.78,21,11.109,21h0 c0.556,0,1.076-0.278,1.385-0.741l4.766-7.15c0.448-0.672,0.448-1.547,0-2.219l-4.766-7.15C12.185,3.278,11.666,3,11.109,3z"></path>
                        </svg>
        ...
        <div className='min-h-screen p-6 flex flex-col items-center justify-center bg-black relative overflow-x-clip'>
            ...
            <div className='flex flex-col md:w-[60vw] lg:w-[71vw] relative z-[100]'>
                <p className='text-xs md:text-sm lg:text-base font-LibreBaskerville font-bold bg-gradient-to-b text-transparent bg-clip-text from-yellow-300 to-yellow-500'>Ceremony</p>
                <p className='text-2xl md:text-3xl lg:text-5xl font-LibreBaskerville font-bold bg-gradient-to-b text-transparent bg-clip-text from-yellow-300 to-yellow-500'>Civil Reunion Night : “Back to Home”</p>
                <p className='text-xs md:text-sm lg:text-xl font-LibreBaskerville font-bold bg-gradient-to-b text-transparent bg-clip-text from-yellow-300 to-yellow-500'>Ceremony adalah rangkaian acara untuk merayakan HUT ke-55 KMTSL. Acara syukuran di Selasar KMTSL melibatkan civitas akademika DTSL dengan karaoke, penampilan band, dan makan bersama. NGOBRAL dengan tema "Civil Engineering for Future Indonesia" berlangsung di Ruang Sidang Biru DTSL UGM. Pada Civil Reunion Night di Laboratorium Bahan Bangunan DTSL UGM, terdapat pembukaan Lustrum, dinner, bincang-bincang antar-alumni dan dosen, serta live music dengan tema "Garden Party."</p>
                <button style={{border: "1px solid var(--gold, #F2D87A)"}} className='w-fit flex flex-row items-center border text-gold-500 px-4 py-2 mt-4 rounded-md font-bold text-xs lg:text-base hover:opacity-80'>Website Ceremony 
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="100" viewBox="0 0 24 24" className="fill-current text-gold-500 h-5">
                            <path d="M11.109,3L11.109,3C9.78,3,8.988,4.481,9.725,5.587L14,12l-4.275,6.413C8.988,19.519,9.78,21,11.109,21h0 c0.556,0,1.076-0.278,1.385-0.741l4.766-7.15c0.448-0.672,0.448-1.547,0-2.219l-4.766-7.15C12.185,3.278,11.666,3,11.109,3z"></path>
                        </svg>
