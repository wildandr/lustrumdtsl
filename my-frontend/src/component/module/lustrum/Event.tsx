    ...
    return (
        ...
        <div className='min-h-screen p-6 flex flex-col items-center justify-center bg-black relative overflow-x-clip'>
            ...
            <div className='absolute min-h-screen w-full'>
                ...
                ></div>
                <div
                    className="-left-[100%] -top-[0%] md:top-[20%] md:-left-[35%] lg:-top-[50%] lg:left-auto lg:right-[-20%] hidden lg:block w-[36rem] h-[36rem] lg:w-[40rem] lg:h-[40rem] mix-blend-lighten"
                    style={{
                        background: "radial-gradient(50% 50% at 50% 50%, rgba(137, 108, 0, 0.35) 0%, rgba(255, 235, 162, 0.00) 100%)",
                        filter: 'box-shadow(0px 0px 50px rgba(251, 222, 11, 1))',
                        borderRadius: '50%',
            ...
            <div className='flex flex-col md:w-[60vw] lg:w-[71vw] relative z-[100] text-end lg:text-start'>
        ...
        <div className='min-h-screen p-6 flex flex-col items-center justify-center bg-black relative overflow-x-clip'>
            ...
            <div className='flex flex-col md:w-[60vw] lg:w-[71vw] relative z-[100]'>
                ...
                <p className='mt-4 text-2xl md:text-3xl lg:text-5xl font-sfui bg-gradient-to-b text-transparent bg-clip-text from-[#F2D87A] to-[#E0B620]'>Clapeyron Proyek dan Expo Ke-8</p>
        ...
        <div className='min-h-screen p-6 flex flex-col items-center justify-center bg-black relative overflow-x-clip'>
            ...
            <div className='flex flex-col md:w-[60vw] lg:w-[71vw] relative z-[100] text-end lg:text-start'>
                ...
                <p className='mt-4 text-2xl md:text-3xl lg:text-5xl font-sfui bg-gradient-to-b text-transparent bg-clip-text from-[#F2D87A] to-[#E0B620]'>Civil Reunion Night : “Back to Home”</p>
