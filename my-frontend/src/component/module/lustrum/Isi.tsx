    ...
    return (
        ...
        <div className='min-h-screen pt-[17%] p-6 flex flex-col items-center justify-center bg-black relative overflow-x-clip'>
            ...
            <div className='flex flex-col md:w-[60vw] lg:w-[71vw] relative z-[100]'>
                ...
                <p className='text-2xl md:text-3xl lg:text-5xl font-LibreBaskerville bg-gradient-to-b text-transparent bg-clip-text from-[#F2D87A] to-[#E0B620] mt-4'>Civil in Action x Pelayanan Komputer Teknik Sipil dan Lingkungan</p>
                ...
                <Link href={`cia`} style={{border: "1px solid var(--gold, #F2D87A)"}} className='w-fit flex flex-row items-center border bg-gradient-to-b bg-clip-text from-[#F2D87A] to-[#E0B620] text-gold-500 px-4 py-2 mt-5 md:mt-8 rounded-xl font-bold text-xs lg:text-base hover:opacity-80'>Website CIA X PKTSL
                    <span>
