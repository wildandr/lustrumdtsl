    ...
    return (
        ...
        <div className='min-h-screen pt-[17%] p-6 flex flex-col items-center justify-center bg-black relative overflow-hidden'>
            ...
            <div className='flex flex-col md:w-[60vw] lg:w-[71vw] relative z-[100]'>
                ...
                <button style={{border: "1px solid var(--gold, #F2D87A)"}} className='w-fit flex flex-row items-center border text-gold-500 px-4 py-2 mt-4 rounded-md font-bold text-xs lg:text-base hover:opacity-80'>Website Resmi 
                    <span>
