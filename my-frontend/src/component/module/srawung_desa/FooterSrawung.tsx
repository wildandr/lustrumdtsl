...
export default function FooterSrawung() {
  ...
  return (
    <footer
      className={`relative overflow-x-clip max-[385px]:h-[112vh] h-[92vh] min-[450px]:h-[80vh] md:h-[55vh] lg:h-[60vh] xl:h-[48vh] lg:pb-[30%] md:pb-0 bg-[#0A4C0E]`}
    >
      <div className="flex w-full md:px-8 lg:px-32">
        <div className="w-1/2 h-[0.1rem] bg-[#ffffff] " />
      </div>
      <Image
        ...
        height={1000}
        alt="Lustrum Logo"
        className="h-full w-auto md:h-[100%] absolute top-0 right-0 z-10 lg:hidden"
      />
      ...
      <Image
        ...
        height={1000}
        alt="Lustrum Logo"
        className="w-[70%] h-auto absolute bottom-0 right-0 lg:flex hidden"
      />
      ...
      <div className="h-[100%] w-full z-20 absolute bottom-0 p-8 lg:px-32">
        <div className="md:flex md:flex-row md:gap-10 md:items-center md:justify-center lg:justify-start">
          ...
          <div className="flex-col  flex items-start gap-4 mt-4 ">
            <p className={`  font-bold text-xl   text-[#ffffff] z-30 `}>
              Event
            </p>
            <Link href="/cia" className="flex items-center gap-3">
              <p className="text-[#ffffff] z-30">Civil in action</p>
              <svg
            ...
            <Link href="#" className="flex items-center gap-3">
              <p className="text-[#ffffff] z-30">Srawung Desa</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
            ...
            <Link href="#" className="flex items-center gap-3">
              <p className="text-[#ffffff] z-30">Claproyex</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
            ...
            <Link href="#" className="flex items-center gap-3">
              <p className="text-[#ffffff] z-30">Ceremony</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
          ...
          <div className="flex-col flex items-start gap-4 mt-8  md:mt-4">
            ...
            <Link href="/craft" className="flex items-center gap-3">
              <p className="text-[#ffffff] z-30">Registrasi peserta CRAFT</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
            ...
            <Link href="/cia" className="flex items-center gap-3">
              <p className="text-[#ffffff] z-30">Registrasi peserta CIC</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
            ...
            <Link href="/sbc" className="flex items-center gap-3">
              <p className="text-[#ffffff] z-30">Registrasi peserta SBC</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
            ...
            <Link href="/fcec" className="flex items-center gap-3">
              <p className="text-[#ffffff] z-30">Registrasi peserta FCEC</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
                y="0px"
        ...
        <div className="mt-8 flex flex-col items-center gap-4 justify-center  w-full">
          <div className="w-full h-[0.1rem] bg-[#ffffff]" />
          <div className="lg:flex justify-center lg:items-center lg:justify-between w-full">
            <div className="flex items-center gap-4 justify-center lg:justify-start w-full">
              <Link
                href="#"
                className="border-2 rounded-full p-4 border-opacity-20  border-[#ffffff] "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
            ...
            <p className="text-center font-bold w-full mt-4 lg:mt-0 lg:text-end text-sm lg:justify-end text-[#ffffff] z-30">
