...
export function Form() {
  ...
  const LeaderKtm = teamData.leader.ktm.split("/uploads/sbc/");
  const LeaderSPSA =
    teamData.leader.active_student_letter.split("/uploads/sbc/");
  const LeaderFoto = teamData.leader.photo.split("/uploads/sbc/");
  const Member1Ktm = teamData.member1.ktm.split("/uploads/sbc/");
  const Member1SPSA =
    teamData.member1.active_student_letter.split("/uploads/sbc/");
  const Member1Foto = teamData.member1.photo.split("/uploads/sbc/");
  const Member2Ktm = teamData.member2.ktm.split("/uploads/sbc/");
  const Member2SPSA =
    teamData.member2.active_student_letter.split("/uploads/sbc/");
  const Member2Foto = teamData.member2.photo.split("/uploads/sbc/");
  const DosbimFoto = teamData.dosbim.photo.split("/uploads/sbc/");
          ...
          <div className="font-LibreBaskerville text-cia-green lg:mx-[15%] mt-[3%] lg:mb-[1%] lg:text-lg text-[0.7rem] min-w-screen mx-[17%]">
            <ol className="list-decimal pl-2">
              <li className="mb-1">
                ...
                08.00 hingga 17 Maret 2024 pukul 23.59 dan TOR soal akan rilis
                pada tanggal 18 Maret 2024;
              </li>
              <li className="mb-1">
                Peserta diharapkan untuk membayar biaya pendaftaran sebesar
                Rp350.000/tim yang dapat dilakukan dengan cara transfer ke
                rekening 1800013302668 Bank Mandiri atas nama BALQIS SYBIL
                BUANAWAT dengan menambahkan kode unik 213 (nominal yang
                dibayarkan menjadi Rp350.213,00);
              </li>
              <li className="mb-1">
                Dalam proses transaksi/transfer, peserta diharapkan untuk
                menambahkan keterangan “Registrasi SBC 2024” pada kolom
              ...
              <li className="mb-1">
                ...
                <ol className="list-lower-alpha pl-5">
                  <li className="mb-1">
                    Scan Kartu Tanda Mahasiswa (JPG/JPEG/PNG) Format penamaan
                    file: KTM_Nama Tim_Nama Peserta Contoh: KTM_All Stars_Nayla
                    Putri
                  </li>
                  <li className="mb-1">
                    Scan surat keterangan mahasiswa aktif (JPG/JPEG/PNG) Format
                    penamaan file: SKMA_ Nama Tim_Nama Peserta Contoh: SKMA_All
                    Stars_Nayla Putri
                  </li>
                  <li className="mb-1">
                    Pas foto 3x4 (JPG/JPEG/PNG) Format penamaan file:
                    Pasfoto_Nama Tim_Nama Peserta Contoh: Pasfoto_All
                    Stars_Nayla Putri
                  </li>
                  <li className="mb-1">
                    Scan bukti pembayaran (JPG/JPEG/PNG) Format penamaan file:
                    Bukti Pembayaran_Nama Tim Contoh: Bukti Pembayaran_All Stars
                  </li>
                  <li className="mb-1">
                    Scan bukti voucher (JPG/JPEG/PNG) Format penamaan file:
                    Bukti Voucher_Nama Tim Contoh: Bukti Voucher _All Stars
                  </li>
                </ol>
              </li>
            </ol>
                  ...
                  >
                    <form className="w-full flex flex-col gap-4 font-sans">
                      ...
                      <div className="flex flex-col gap-1 border-b-2 pb-2 border-[#18AB8E] ">
                        ...
                        <input
                          type="file"
                          className="text-[0.7rem] md:text-sm text-white xl:w-1/3"
                  ...
                  >
                    <form className="w-full flex flex-col gap-4">
                      <Input
                        ...
                        variant="underlined"
                        color="primary"
                        value={teamData.dosbim.full_name}
                        onChange={(e) =>
                          setTeamData((prevState) => ({
                            ...prevState,
                            dosbim: {
                      ...
                      <Input
                        ...
                        variant="underlined"
                        color="primary"
                        value={teamData.dosbim.phone_number}
                        onChange={(e) =>
                          setTeamData((prevState) => ({
                            ...prevState,
                            dosbim: {
