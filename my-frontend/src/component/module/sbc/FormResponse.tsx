    ...
    async function downloadFilesAsZip() {
        ...
        for (const member of teamData.members) {
            ...
            if (ktm && active_student_letter && photo) {
                ...
                zip.file(
                    photo.split("/").pop() ?? "photo_default_name",
                    photoData
                );
            }
        }
                ...
                <div className="bg-white p-4 rounded-xl  w-[90%] mx-auto mt-28 ">
                    ...
                    <div className="mt-4 flex flex-col gap-2">
                        ...
                        <div className="flex flex-col w-full ">
                            ...
                            <div className="px-6 py-2 rounded-xl bg-[#B5E5DB]">
                                {teamData.leader?.active_student_letter &&
                                    (teamData.leader?.active_student_letter.endsWith(
                                        ".jpg"
                                    ) ||
                                    teamData.leader?.active_student_letter.endsWith(
                                        ".jpeg"
                        ...
                        <div className="flex flex-col w-full ">
                            ...
                            <div className="px-6 py-2 rounded-xl bg-[#B5E5DB]">
                                {teamData.members[0]?.active_student_letter &&
                                    (teamData.members[0]?.active_student_letter.endsWith(
                                        ".jpg"
                                    ) ||
                                    teamData.members[0]?.active_student_letter.endsWith(
                                        ".jpeg"
                        ...
                        <div className="flex flex-col w-full ">
                            ...
                            <div className="px-6 py-2 rounded-xl bg-[#B5E5DB]">
                                {teamData.members[0]?.ktm &&
                                    (teamData.members[0]?.ktm.endsWith(
                                        ".jpg"
                                    ) ||
                                    teamData.members[0]?.ktm.endsWith(
                                        ".jpeg"
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <div className="px-6 py-2 rounded-xl bg-[#B5E5DB]">
                                {teamData.members[0]?.photo &&
                                    (teamData.members[0]?.photo.endsWith(
                                        ".jpg"
                                    ) ||
                                    teamData.members[0]?.photo.endsWith(
                                        ".jpeg"
                        ...
                        <div className="flex flex-col w-full ">
                            ...
                            <div className="px-6 py-2 rounded-xl bg-[#B5E5DB]">
                                {teamData.members[1]?.active_student_letter &&
                                    (teamData.members[1]?.active_student_letter.endsWith(
                                        ".jpg"
                                    ) ||
                                    teamData.members[1]?.active_student_letter.endsWith(
                                        ".jpeg"
                        ...
                        <div className="flex flex-col w-full ">
                            ...
                            <div className="px-6 py-2 rounded-xl bg-[#B5E5DB]">
                                {teamData.members[1]?.ktm &&
                                    (teamData.members[1]?.ktm.endsWith(
                                        ".jpg"
                                    ) ||
                                    teamData.members[1]?.ktm.endsWith(
                                        ".jpeg"
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            <div className="px-6 py-2 rounded-xl bg-[#B5E5DB]">
                                {teamData.members[1]?.photo &&
                                    (teamData.members[1]?.photo.endsWith(
                                        ".jpg"
                                    ) ||
                                    teamData.members[1]?.photo.endsWith(
                                        ".jpeg"
                        ...
                        <div className="flex flex-col w-full ">
                            ...
                            <div className="px-6 py-2 rounded-xl bg-[#B5E5DB]">
                                {teamData.dosbim[0]?.photo &&
                                    (teamData.dosbim[0]?.photo.endsWith(
                                        ".jpg"
                                    ) ||
                                    teamData.dosbim[0]?.photo.endsWith(
                                        ".jpeg"
