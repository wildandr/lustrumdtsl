    ...
    return (
        <div className="flex justify-between items-center mb-48 mt-20 sm:mt-28 ">
          <Image
            ...
            width={1000}
            height={1000}
            className="mx-auto w-[65%] h-[75%] md:w-[33%] md:h-[22%] min-[920px]:h-[28%]  lg:h-[23%] xl:w-[23%] xl:h-[30%]  md:absolute md:top-[14rem] min-[920px]:top-[30%]  md:left-20 lg:top-64 lg:left-32 xl:top-56 xl:left-56"
          />
          ...
          <Image
            ...
            width={600}
            height={600}
            className="hidden md:flex  sm:w-[50px] md:h-[70px] xl:w-[70px] xl:h-[90px] absolute md:top-[50%]  md:left-[42%] min-[920px]:top-[60%] lg:top-[32rem] lg:left-[40%] xl:top-[30rem] xl:left-[42%]"
            style={{ transform: `rotate(${rotation}deg)` }}
          />
          <Image
