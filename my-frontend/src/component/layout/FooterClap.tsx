...
export default function Footer() {
  ...
  return (
    <footer 
      className={`relative overflow-x-clip max-[385px]:h-[112vh] h-[92vh] min-[450px]:h-[80vh] md:h-[55vh] lg:h-[60vh] xl:h-[48vh] lg:pb-[30%] md:pb-0 bg-[#83B9D5]`}
    >
      <div className="flex w-full md:px-8 lg:px-32">
        <div className="w-1/2 h-[0.1rem] bg-[#233e61] "/>
        </div>
      <Image
        ...
        height={1000}
        alt="Lustrum Logo"
        className="h-full w-auto md:h-[100%] absolute top-0 right-[-50%] z-10 lg:hidden"
      />
      ...
      <div className="h-[100%] w-full z-20 absolute bottom-0 p-8 lg:px-32">
        ...
        <div className="mt-8 flex flex-col items-center gap-4 justify-center  w-full">
          <div className="w-full h-[0.1rem] bg-[#233e61]" />
          <div className="lg:flex justify-center lg:items-center lg:justify-between w-full">
            <div className="flex items-center gap-4 justify-center lg:justify-start w-full">
              <Link
                href="#"
                className="border-2 rounded-full p-4 border-opacity-20  border-[#233e61] "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
